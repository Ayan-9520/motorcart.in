...
export const CUSTOMER_ECOSYSTEM_NAV: CustomerNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/finance/tools", label: "EMI Tracker", icon: CreditCard },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/services/book", label: "RSA / Breakdown", icon: Shield },
    ],
  },
  {
    label: "Community",
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/profile/kyc", label: "KYC Verification", icon: Shield },
      { to: "/dashboard/customer/profile#security", label: "Account Security", icon: Settings },
      { to: "/dashboard/customer/profile#notifications", label: "Notification Preferences", icon: Bell },
